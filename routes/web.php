...
//terbuat file dengan nama local-example.txt di folder /storage/app pada project laravel
Route::get('/local-disk', function() {
    Storage::disk('local')->put('local-example.txt', 'This is local example content');
    return asset('storage/local-example.txt');
});

//terbuat file dengan nama public-example.txt di folder /storage/app/public pada project laravel
